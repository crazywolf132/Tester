...
import com.fdoom.entity.Anvil;
import com.fdoom.entity.Brewery;
import com.fdoom.entity.Chest;
import com.fdoom.entity.Furnace;
import com.fdoom.entity.Lantern;
import com.fdoom.entity.Oven;
import com.fdoom.entity.Workbench;
import com.fdoom.item.ToolType;
import com.fdoom.item.resource.Resource;
import com.fdoom.GameContainer;
import com.fdoom.entity.*;
...
public class Crafting {
	...
	static {
		try {
			...
			workbenchRecipes.add(new ItemRecipe(Bow.class).addCost(Resource.wood, 1).addCost(Resource.cloth, 1));
			...
			GameContainer.Logger(java.util.logging.Level.SEVERE,"We have an error in Crafting. Please send to Dev!");
		}
	}
}